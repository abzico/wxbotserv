 ...
 * @param  {Function}  fn   Function to be executed. Its signature is fn(index, ...args) in which index is current index in looping, and ...args is arbitrary as per function needs for its parameters. The function itself returns Promise object.
